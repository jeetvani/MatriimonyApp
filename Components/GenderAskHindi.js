...
export default class GenderAskHindi extends React.Component {
    render() {

        //If Person is Male
        const Maleselection = () => {
            AsyncStorage.setItem("Gender", "Male")
            this.props.navigation.navigate("MainFormHindi")
        }
        //If Person is Male
        //If Person is Female
            ...
            <View style={{ flex: 1, justifyContent: 'center', flexDirection: 'row', alignItems: 'center' }}>
                <View style={{ flex: 1, justifyContent: 'center', flexDirection: 'row', alignItems: 'center' }}>
                    <TouchableOpacity onPress={Femaleselection}>
                        ...
                        <Text style={{ fontWeight: 'bold', fontSize: 30 }}>महिला </Text>
                    </TouchableOpacity>
                </View>
                <View style={{ flex: 1, justifyContent: 'center', flexDirection: 'row', alignItems: 'center' }}>
                    <TouchableOpacity onPress={Maleselection}>
                        ...
                        <Text style={{ fontWeight: 'bold', fontSize: 30 }}>पुरुष</Text>
                    </TouchableOpacity>
                </View>
